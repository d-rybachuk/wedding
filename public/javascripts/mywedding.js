...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2015/08/30 00:00:00');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">We done this!</span></span>');
 timer.countDown();
}
...
$(".img-portfolio").on('click', function(){
    ...
    $.get( "/api/photoList", function( data ) {
       showGalery(data);
    }, "json");
});

function showGalery(items) {
